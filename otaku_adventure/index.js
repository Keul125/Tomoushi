bs.jeux['otaku_adventure'] = {
	...
	afficher_liste_questions: function() {
		...
		out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].ajouter_pion();">Ajouter un pion</span>';
		
		
		
		out+='<span id="pionavancetext">Cliquer sur le pion à avancer</span>';
		...
		for (p=0 ; p<bs.jeux['otaku_adventure'].pions.length; ++p) {
			...
			document.getElementById('pion_'+bs.jeux['otaku_adventure'].pions[p][0]).onclick= function() { bs.jeux['otaku_adventure'].clickedpion(this.id); };;
		}
	...
	clickedpion: function(pion) {
		
		for (p=0 ; p<bs.jeux['otaku_adventure'].pions.length; ++p) {
			if('pion_'+bs.jeux['otaku_adventure'].pions[p][0]==pion) {
				this.current_pion=p;
				
				
				
				var out=''+this.pions[p][0]+'';
					
					
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(1);" style="background:'+this.pions[p][2]+'">1</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(2);" style="background:'+this.pions[p][2]+'">2</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(3);" style="background:'+this.pions[p][2]+'">3</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(4);" style="background:'+this.pions[p][2]+'">4</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(5);" style="background:'+this.pions[p][2]+'">5</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(6);" style="background:'+this.pions[p][2]+'">6</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(7);" style="background:'+this.pions[p][2]+'">7</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(8);" style="background:'+this.pions[p][2]+'">8</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(9);" style="background:'+this.pions[p][2]+'">9</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(10);" style="background:'+this.pions[p][2]+'">10</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(11);" style="background:'+this.pions[p][2]+'">11</span>';
				out+='<span class="bouton" onclick="bs.jeux[\'otaku_adventure\'].avancer_pion(12);" style="background:'+this.pions[p][2]+'">12</span>';
				
				document.getElementById('pionavancetext').innerHTML=out;
	...
	avancer_pion: function(cases) {
		this.current_pion;	
		posactuelle=this.pions[this.current_pion][1];
		
		newpos=parseInt(posactuelle)+parseInt(cases);
		
		//alert(newpos);
		//alert(this.plateau_width*this.plateau_height);
		if(newpos<this.plateau_width*this.plateau_height) {
		
		
			this.pions[this.current_pion][1]=newpos;
	...
	afficher_plateau: function(for_admin) {
		...
		var cases=bs.jeux['otaku_adventure'].liste_categories;
		...
		if(for_admin) {
			...
			for (y=0 ; y<bs.jeux['otaku_adventure'].plateau_height; ++y) {
				...
				for (x=0 ; x<bs.jeux['otaku_adventure'].plateau_width; ++x) {
					...
					//console.dir(cases[color]['couleurcaseplateau'])
					
					out3+='<td id="cell_'+board2[0][x][y]+'" class="okp_case" style="'+board2[2][x][y]+';background-color:'+cases[color]['couleurcaseplateau']+'">';
					...
					out3+='<div id="cellnumber_'+board2[0][x][y]+'" class="" style="float:right;">'+board2[0][x][y]+'</div>';
			...
			for (y=0 ; y<bs.jeux['otaku_adventure'].plateau_height; ++y) {
				...
				for (x=0 ; x<bs.jeux['otaku_adventure'].plateau_width; ++x) {
					...
					out3+='<td id="pub_cell_'+board2[0][x][y]+'" class="okp_case" style="'+board2[2][x][y]+';background-color:'+cases[color]['couleurcaseplateau']+'">';
					for (p=0 ; p<pions.length; ++p) {
						if((pions[p][1]+1)==board2[0][x][y]) {
